  ...
  return (
    <>
      <button
        ...
        className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-blue-700/10 dark:hover:bg-blue-700/50 transition"
      >
